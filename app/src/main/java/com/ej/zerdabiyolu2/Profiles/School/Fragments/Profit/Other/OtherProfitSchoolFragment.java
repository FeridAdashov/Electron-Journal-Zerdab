...
public class OtherProfitSchoolFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
    ...
    private SchoolRecyclerOtherPayment adapter;
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        databaseReference = DatabaseFunctions.getDatabases(activity).get(0).child("PROFIT/OTHER");
    ...
    private void configureBtnOther() {
        ...
        btnOther.setOnClickListener(view12 -> {
            ...
            final EditText nameOfProfit = dialogView.findViewById(R.id.nameOfProfit);
            final EditText amountOfProfit = dialogView.findViewById(R.id.amountOfProfit);
            ...
            builder.setPositiveButton(R.string.ok, (di, i) -> {
                ...
                final String aop = amountOfProfit.getText().toString();

                if (aop.equals("") || aop.equals(".")) return;
                double amount = Double.parseDouble(aop);

                String name = nameOfProfit.getText().toString();
                ...
                DatabaseFunctions.getDatabases(activity).get(0).child("REPORT/OtherPayment/" + date + " " + time).setValue(amount);
    ...
    private void configureListViewPayments() {
        adapter = new SchoolRecyclerOtherPayment(nameList, searchNameList, dateList, amountList);
