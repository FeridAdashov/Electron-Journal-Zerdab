...
public class StudentExamsFragment extends Fragment implements DatePickerDialog.OnDateSetListener {
        ...
        expListView.setOnItemLongClickListener((parent, view, position, id) -> {
            ...
            new AlertDialog.Builder(context)
                    ...
                    .setPositiveButton(R.string.ok, (dialog, which) ->
                            StorageFunctions.storeStudentAllExamData(activity, databaseReference.child("EXAM_HISTORY/" + username)))
    ...
    private void showDialog(int headerPos, int childPos) {
        ...
        databaseReference.child("EXAM_HISTORY/" + username + "/" + date + "/" + time)
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        progressDialog.dismiss();

                        StudentExamModel examModel = dataSnapshot.getValue(StudentExamModel.class);

                        ShowExamDataDialog dialog = new ShowExamDataDialog();
                        dialog.setDefaultValues(examModel);
    ...
    private void load() {
        ...
        databaseReference.child("EXAM_HISTORY/" + username).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
