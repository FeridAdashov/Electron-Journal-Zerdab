...
public class SchoolRecyclerExpenditure extends RecyclerView.Adapter<SchoolRecyclerExpenditure.MyViewHolder> {
    ...
    public SchoolRecyclerExpenditure(ArrayList<String> nameList,
